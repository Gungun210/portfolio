...
const certs: Cert[] = [
  {
    ...
    icon: Database,
    href: "/certificates/infosys-sql.png",
  },
  {
    ...
    icon: BarChart3,
    href: "/certificates/tata-data-visualization.png",
  },
  {
    ...
    icon: Brain,
    href: "/certificates/tata-genai-analytics.png",
  },
  {
    ...
    icon: Heart,
    href: "/certificates/nptel-emotional-intelligence.png",
    badge: "Silver Elite",
  },
];
